...
=======
                  configDir = /Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode
>>>>>>> 1763127 (chore: init gsd)
                  → checks /Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done
                  → writes to /Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
