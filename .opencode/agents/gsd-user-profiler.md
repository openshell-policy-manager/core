...
=======
@/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/references/user-profiling.md
...
=======
Read the user-profiling reference document at `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/references/user-profiling.md` to load:
>>>>>>> 1763127 (chore: init gsd)
