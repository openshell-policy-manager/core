...
- **Global scope**: `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/notes/`)
...
2. Glob `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/notes/` — works in any directory
