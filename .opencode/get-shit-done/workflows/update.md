...
<<<<<<< HEAD
global: `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, or `~/.codex/`
local: `./.opencode/`, `./.config/opencode/`, `./.opencode/`, `./.gemini/`, or `./.codex/`)
=======
global: `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, `~/.config/kilo/`, or `~/.codex/`
