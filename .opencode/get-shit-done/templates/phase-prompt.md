...
<!-- For checkpoint task examples and patterns, see @/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/references/checkpoints.md -->
...
See `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/tkopatz/dev/work/tk-repos/openshell-policy-manager/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
